                    ...
                    <Fade>
                        <Container text>
                            <div className={styles.firstSection}>
                                ...
                                <Divider hidden />
                                We welcome your suggestions, feedbacks or ideas which will help us bring a better experience for the community. We will get back to you as soon as possible (within 5 working days)!
                                <Divider hidden />

                                <div className={styles.contacts}>
                                    <Button inverted color='blue' onClick={() => {window.open("https://www.facebook.com/", "_blank")}} className={styles.button}>
                                        Facebook
                                    </Button>
                                    <Button inverted color='blue' onClick={() => {window.open("https://twitter.com/", "_blank")}} className={styles.button}>
                                        Twitter
                                    </Button>
                                    <Button inverted color='blue' onClick={() => {window.open("https://www.linkedin.com/company/babybiome/", "_blank")}} className={styles.button}>
                                        Linkedin
                                    </Button>
                                    <Button inverted color='blue' onClick={() => window.location = "mailto:glenn_quek@u.nus.edu?Subject=BabyBiome%20Feedback"} className={styles.button}>
                                        Email
                                    </Button>
                                </div>
                            </div>
